...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#050505] border-r border-[#222226] fixed top-18 bottom-0 left-0 z-30 p-4 flex flex-col justify-between overflow-y-auto">
      <div className="space-y-6">
        <div>
          <div className="tag-purple px-2 mb-3 text-xs font-bold">
            &lt; NAVIGATION &gt;
          </div>
            ...
            {navItems.map((item) => {
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-3 px-3.5 py-3 text-sm font-mono font-bold uppercase transition-all tracking-wider ${
                      isActive
                        ? 'bg-purple-950/50 text-white border-l-4 border-purple-500 bg-gradient-to-r from-purple-900/40 to-transparent'
        ...
        <div className="p-4 bg-[#0C0C0E] border border-[#222226] text-xs text-neutral-300 space-y-2.5 font-mono">
          ...
          <div className="text-xs bg-[#030304] p-2 border border-[#222226] text-purple-300 font-bold leading-tight">
